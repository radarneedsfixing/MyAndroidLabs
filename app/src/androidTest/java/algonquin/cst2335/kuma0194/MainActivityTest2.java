...
/**
 * Tests the password complexity validation in the MainActivity.
 */
public class MainActivityTest2 {
    ...
    public void paswordComplexity() {
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.editText),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("Seenu@5182"), closeSoftKeyboard());
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.textView), withText("Your password meets all the requirements"),
